select a.ea, a.treatment, a.county, a.route, a.year, ('Beg PM: ' || to_char(a.beg_pm, 990.999)) as "Beg PM", a.end_pm, (a.end_pm-a.beg_pm) as length, a.budget_group from s1383currentl a
where a.county = 'SON'
union 
...
select a.ea, a.treatment, a.county, a.route, a.year, ('Beg PM: ' || to_char(a.beg_pm, 990.999)) as "Beg PM", a.end_pm, (a.end_pm-a.beg_pm) as length, a.budget_group from s1383currentr a
where a.county = 'SON' 
union 
